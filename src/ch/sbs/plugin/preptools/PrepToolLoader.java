...
public class PrepToolLoader {
	...
	public static final String ORDINAL_TAG = makeNumRegex("ordinal");

	// Römische Zahlen
	// case sensitive
	public static final String ROMAN_REGEX = "\\b[IVXCMLD]+\\b\\.?";
	public static final String ROMAN_TAG = makeNumRegex("roman");
	...
	public static final String MEASURE_TAG = makeNumRegex("measure");
	...
	public static final String ACCENT_REPLACE = "<span brl:accents=\""
			+ PLACEHOLDER + "\">$1</span>";
	public static final String ACCENT_TAG = "span.*?";
	...
	public static List<PrepTool> loadPrepTools(
		...
		prepTools.add(new AccentPrepTool(thePrepToolsPluginExtension, i++, 'a',
				"Accent", ACCENT_REGEX, ACCENT_TAG, ACCENT_REPLACE));
		return prepTools;
	}

	private static String makeNumRegex(final String role) {
